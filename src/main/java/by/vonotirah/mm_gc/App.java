...
public class App {
	public static void main(String[] args) {
		...
		Class4Example firstClass = new Class4Example(
				"This is first class message");
		...
		System.out.println("-------------------------------------------------");
		System.out.println("References example");
		System.out.println("-------------------------------------------------");
		RefercesService refService = new RefercesService();
		refService.runExample();
	}
}
